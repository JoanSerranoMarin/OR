...
"""
Compact two-region GPCR volume figure.
...
from the parent folder names of the input Excel files, for example:
    ...
    volumen_3_cleaft_volume   -> TM5–TM7 cleft
...
def main():
    ...
    ap.add_argument(
        "--outfig",
        default="figure_transmembrane_volumes_2x2_letters.png",
        help="Output PNG file.",
    )
    ap.add_argument(
        "--outpdf",
        default="figure_transmembrane_volumes_2x2_letters.pdf",
        help="Output PDF vector file.",
    )
    ap.add_argument(
        "--excel-out",
        default="gpcr_transmembrane_stats_BH_2x2_letters.xlsx",
